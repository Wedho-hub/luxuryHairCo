const Logo = ({ className = "" }) => (
  <div className={`flex items-center gap-3 ${className}`}>
    ...
    >
      ...
      <path
        fill="#1a1008"
        d="M 82 36 C 88 18,108 8,128 14 C 148 20,162 40,168 66
           C 172 88,168 116,156 136 C 146 152,130 162,114 165
           C 104 168,95 163,93 153 C 91 143,94 128,96 112
           C 98 96,100 80,96 66 C 92 54,86 44,82 38 Z"
      />
      ...
      <path
        fill="#1a1008"
        d="M 114 165 C 118 176,114 188,106 192 C 100 195,94 190,95 185
           C 98 188,103 187,107 183 C 113 177,115 168,112 160 Z"
      />
      ...
      <path
        fill="#c9a227"
        d="M 66 122 C 62 130,62 140,66 146 C 70 150,76 150,79 146
           C 74 145,69 141,68 133 C 66 126,66 124,66 122 Z"
        opacity="0.6"
      />
      <path
        d="M 68 54 C 63 66,60 80,61 94 C 62 106,65 116,68 122"
        stroke="#7a5010" strokeWidth="1.5" fill="none" opacity="0.28" strokeLinecap="round"
      />

      {/* SILK SCULPTURE wordmark */}
      <text
        x="100" y="212"
        fontFamily="Georgia, 'Times New Roman', serif"
        fontSize="18" fontWeight="bold"
        fill="#c9a227" textAnchor="middle" letterSpacing="3"
      >
        SILK SCULPTURE
      </text>
      ...
      <text
        ...
        fill="#ffffff" textAnchor="middle" letterSpacing="8"
      >
        HAIR
      </text>
    </svg>

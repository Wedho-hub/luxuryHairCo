        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-4 px-6 py-4 md:flex-row md:items-center md:justify-between">
          ...
          <nav aria-label="Social media" className="flex flex-wrap items-center justify-center gap-3 md:justify-end">
            <a
              ...
              aria-label="Facebook"
              className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-[#1877F2] text-white transition hover:opacity-90 active:scale-90 select-none"
            >
            ...
            <a
              ...
              className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-[#F58529] via-[#DD2A7B] to-[#515BD4] text-white transition hover:shadow-[0_0_20px_rgba(212,175,55,0.35)] active:scale-90 select-none"
            >
              <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor" aria-hidden="true">
            ...
            <a
              ...
              className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-[#BD081C] text-white transition hover:opacity-90 active:scale-90 select-none"
            >
              <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor" aria-hidden="true">
            ...
            <a
              ...
              rel="noopener noreferrer"
              aria-label="YouTube"
              className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-[#FF0000] text-white transition hover:opacity-90 active:scale-90 select-none"
            >
              <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor" aria-hidden="true">
            ...
            <a
              ...
              rel="noopener noreferrer"
              aria-label="TikTok"
              className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-black text-white transition hover:opacity-90 active:scale-90 select-none"
            >
              <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor" aria-hidden="true">

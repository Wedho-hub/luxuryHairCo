      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-4 px-6 py-4 md:flex-row md:items-center md:justify-between">
        ...
        <nav aria-label="Social media" className="flex flex-wrap items-center gap-3">
          ...
          <a
            ...
            className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-linear-to-br from-[#F58529] via-[#DD2A7B] to-[#515BD4] text-white transition hover:opacity-90"
          >
            <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor" aria-hidden="true">
